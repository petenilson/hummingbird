...
func findTransferById(ctx context.Context, tx *Tx, id int) (*hummingbird.Transfer, error) {
...
func findTransfers(
	...
	defer rows.Close()
	transfers := make([]*hummingbird.Transfer, 0)
	transfer_count := 0
	for rows.Next() {
...
func attachTransaction(
	ctx context.Context, tx *Tx, transfer *hummingbird.Transfer,
) error {
...
func createTransfer(ctx context.Context, tx *Tx, transfer *hummingbird.Transfer) error {
